  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.filtersRow}>
        <Pressable onPress={() => setDateModal(true)} style={styles.filterChip}>
          <Text style={styles.filterText}>Data</Text>
        </Pressable>
        <Pressable onPress={() => setGenreModal(true)} style={styles.filterChip}>
          <Text style={styles.filterText}>Gênero</Text>
        </Pressable>
        <Pressable onPress={() => setPlatformModal(true)} style={styles.filterChip}>
