...
import { useCurrentlyGaming, useProfileHeader, useSteamTrophies, useWishlist } from '@/hooks/useProfile';
import { useAuth } from '@/providers/AuthProvider';
import { getFavoriteUserGame, igdbCoverUrl } from '@/services/profile';
...
export default function PublicProfileScreen() {
  ...
  const trophies = useSteamTrophies(targetId);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.statsRow}>
        ...
        <View style={[styles.statCard, { padding:0, overflow:'hidden' }]}> 
          ...
          <View style={{ padding:8 }}>
            <Text style={[styles.statLabel,{ color: colors.secondary }]}>Jogo favorito</Text>
      ...
      <View style={styles.sectionHeader}>
        <Text style={styles.sectionTitle}>JOGANDO ATUALMENTE</Text>
      </View>
      {playing.isLoading ? (
      ...
      {/* Want to Play */}
      <View style={styles.sectionHeader}>
        <Text style={styles.sectionTitle}>DESEJO JOGAR</Text>
      </View>
      {wishlist.isLoading ? (
        <Text style={styles.subtle}>Carregando...</Text>
